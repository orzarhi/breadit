...
export const PostComment: FC<PostCommentProps> = ({ comment, votesAmt, currentVote, postId }) => {
        ...
        <div ref={commentRef} className='flex flex-col'>
            <div className='flex items-center'>
                ...
                <div className='flex items-center ml-2 gap-x-2'>
                    ...
                    <p className='text-xs truncate max-h-40 text-zinc-500'>{formatTimeToNow(new Date(comment.createdAt))}</p>
                </div>
            </div>
                    ...
                    <div className='grid w-full gap-1.5'>
                        ...
                        <div className='mt-2'>
                            ...
                            <div className='flex justify-end gap-2 mt-2'>
                                <Button tabIndex={-1} variant='subtle' onClick={() => setIsReplying(true)}>Cancel</Button>
                                <Button
                                    isLoading={isLoading}
