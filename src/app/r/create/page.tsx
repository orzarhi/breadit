        ...
        <main className="container flex items-center h-full max-w-3xl mx-auto">
            <div className="relative w-full p-4 space-y-6 bg-white rounded-lg h-fit">
                ...
                <div>
                    ...
                    <p className="pb-2 text-xs">Community names including capitalzation cannot be changed.</p>
                    <div className="relative">
                        <p className="absolute inset-y-0 left-0 grid w-8 text-sm place-items-center text-zinc-400">r/</p>
                        <Input value={input} onChange={({ target }) => setInput(target.value)} className="pl-6" />
                    </div>
                </div>
